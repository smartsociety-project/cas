...
'A <dfn id="concept-reputation_peer">reputation peer</dfn> is a specialisation of a peer, which specialises in storing feedback about subjects and generating reputation and opinion reports about subjects.  ' + 
'</div>  ' + 
' ' + 
...
'A <dfn id="concept-reputation_report">reputation report</dfn> is a report about a subject that contains a set of key value pairs. The key value pairs is a binding between a topic of reputation to a rating value, which is an aggregation of a set ratings for that topic. ' + 
...
'An <dfn id="concept-opinion_report">opinion report</dfn> is a specialisation of a reputation report, which contains a single key value pair and binds an opinion to a value. The value is an aggregation of ratings from a set of reputation topics. ' + 
'</div>  ' + 
' ' + 
'<div class="glossary" id="glossary-submit_feedback">   ' + 
'A <dfn id="concept-submit_feedback">submit feedback</dfn> is an <a>activity</a> that submits a feedback report to the reputation peer. ' + 
'</div>  ' + 
' ' + 
'<div class="glossary" id="glossary-store_feedback">   ' + 
'A <dfn id="concept-store_feedback">store feedback</dfn> is an <a>activity</a> used by reputation peer to store a feedback report within it. ' + 
'</div>  ' + 
' ' + 
'<div class="glossary" id="glossary-compute_reputation">   ' + 
'A <dfn id="concept-compute_reputation">compute reputation</dfn> is an <a>activity</a> that is run by the reputation peer when a feedback report is submitted, it computes a reputation report for all the subjects referred to by the submitted feedback report. ' + 
'</div>  ' + 
' ' + 
'<div class="glossary" id="glossary-feedback_category">   ' + 
'A <dfn id="concept-feedback_category">feedback category</dfn> is a category which a subject is rated, in a feedback report.    ' + 
'</div>  ' + 
' ' + 
'<div class="glossary" id="glossary-reputation_category">   ' + 
'A <dfn id="concept-reputation_category">reputation category</dfn> is a category which a subject is rated, in a reputation  report.   ' + 
'</div>  ' + 
' ' + 
'<div class="glossary" id="glossary-reputation_item">   ' + 
'A <dfn id="concept-reputation_item">reputation item</dfn> is a JSON object that is returned from a GET request to the reputation peer. ' + 
'</div> ' + 
' ' + 
' ' + 
...
'A <dfn id="concept-orchestration_peer">orchestration peer</dfn> is a specialisation of a peer, which specialises in storing feedback about subjects and generating reputation and opinion reports about subjects.  ' + 
'</div>  ' + 
' ' + 
'<div class="glossary" id="glossary-composition_activity">   ' + 
'A <dfn id="concept-composition_activity">composition_activity</dfn> is an <a>activity</a> that may be comprised of the following activities authenticate, compute_composition and compute_task_complement. ' + 
'</div>  ' + 
' ' + 
...
'A <dfn id="concept-compute_composition">compute composition</dfn> is an <a>activity</a> that computes a set of valid <a title="task">tasks</a> given constraints or negiotation inputs. ' + 
'</div>  ' + 
' ' + 
...
'A <dfn id="concept-send_negotiation_response">send_negotiation_response</dfn> is an entity that contains the response to a <a>negotiation activity</a>. ' + 
'</div>  ' + 
' ' + 
...
'A <dfn id="concept-post_task_request">post task request</dfn> is an <a>activity</a> that posts a <a>task</a> to orchestration peer.  ' + 
'</div>  ' + 
' ' + 
...
'A <dfn id="send_request">send request</dfn> is an <a>activity</a> that sends a request to peer. ' + 
'</div>   ' + 
' ' + 
'<div class="glossary" id="glossary-response">   ' + 
'A <dfn id="response">response</dfn> is an entity that is computed in response to a request. ' + 
'</div>  ' + 
' ' + 
