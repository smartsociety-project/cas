...
'A <dfn id="concept-messaging_action" title="messaging_action">messaging action</dfn> is the constituent of a protocol: it involves information exchange and subsequent action. ' + 
'</div> ' + 
' ' + 
...
'A <dfn id="concept-username" title="username">username</dfn> is a string representing the name of a <a>user</a>. ' + 
'</div>  ' + 
' ' + 
